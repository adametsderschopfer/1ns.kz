...
if( isset( $_POST['my_file_upload'] ) ){  
   ...
   $category = $_POST['category'];
    ...
    $uploaddir = $root.'/companyes/'.$date.'';
    $uploaddir2 = '/companyes/'.$date.'';
    ...
    $db->query("INSERT INTO companyes (`title`, `top`, `logo`, `cat_id`, `descr`, `text`) VALUES ('$title', '$top', '$uploaddir2/$file_name', '$category', '$desc', '$text')");
